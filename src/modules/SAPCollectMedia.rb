...
module Yast
  class SAPCollectMediaClass < Module
    def main
     Yast.import "URL"
     Yast.import "UI"
     Yast.import "XML"
...
#                          _("With this installation mode the <b>SUSE-HA for SAP Simple Stack</b> can be installed and configured.") +
     ...
     @scheme_list = [
      ...
      #Type of the selected installation master
      @instMasterType = ""
      
      #Path to the selected installation master
      @instMasterPath
  ...
  SAPCollectMedia = SAPCollectMediaClass.new
  SAPCollectMedia.main
