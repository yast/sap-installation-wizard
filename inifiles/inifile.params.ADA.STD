#############################################################################################################################################################################
#                                                                                                                                                                           #
# Installation service 'SAP NetWeaver 7.5 > MaxDB > SAP Systems > Application Server ABAP > Standard System > Standard System', product id 'NW_ABAP_OneHost:NW750.ADA.ABAP' #
#                                                                                                                                                                           #
#############################################################################################################################################################################

#USED PARAMETERS ##dbhost## ##dbsid## ##ascsInstanceNumber## ##ascsVirtualHostname## ##ciInstanceNumber## ##ciVirtualHostname## ##scsVirtualHostname## ##masterPwd## ##sid##
...
NW_ABAP_Import_Dialog.migmonLoadArgs = -nolog -c 50000 -force_repeat -para_cnt 3
...
# The DB host
NW_ADA_getDBInfo.dbhost = ##dbhost##

# The DB SID
NW_ADA_getDBInfo.dbsid = ##dbsid##

NW_CI_Instance.ascsInstanceNumber = ##ascsInstanceNumber##

NW_CI_Instance.ascsVirtualHostname = ##ascsVirtualHostname##

NW_CI_Instance.ciInstanceNumber = ##ciInstanceNumber##

NW_CI_Instance.ciMSPort = 

NW_CI_Instance.ciVirtualHostname = ##ciVirtualHostname##
...
NW_CI_Instance.scsVirtualHostname = ##scsVirtualHostname##
...
NW_SAPCrypto.SAPCryptoFile = /SAPINST/peter/NWKERNEL745/DATA_UNITS/K_745_U_LINUX_X86_64/DBINDEP/SAPEXE.SAR
...
SdbPreInstanceDialogs.UseRecreateInstance = ask_user

Sdb_ClientSoftware_Dialogs.indep_data_drive = 

Sdb_ClientSoftware_Dialogs.indep_prog_drive = 

Sdb_ClientSoftware_Dialogs.installation_drive = 

# Password of Database System Administrator 'superdba'
Sdb_DBUser.dbaPassword = ##masterPwd##

# Password of Database Manager Operator 'control'
Sdb_DBUser.dbmPassword = ##masterPwd##

# The Default Code for the Database Schema unicode/ascii
Sdb_Schema.dbaPassword = 

# The Default Code for the Database Schema unicode/ascii
Sdb_Schema.dbmPassword = 

# Password of the database user
Sdb_Schema_Dialogs.dbSchemaPassword = ##masterPwd##

# Password of the database administrator
Sdb_Schema_Dialogs.dbaPassword = 

# Password of the database manager
Sdb_Schema_Dialogs.dbmPassword = 

Sdb_ServerSoftware_Dialogs.dependent_drive = 

Sdb_ServerSoftware_Dialogs.indep_data_drive = 

Sdb_ServerSoftware_Dialogs.indep_prog_drive = 

# Password of superdba db user
Sdb_Xuser.dbaPassword = 

# Password of control db user
Sdb_Xuser.dbmPassword = 
...
nwUsers.ada.sqdsidId = 

nwUsers.ada.sqdsidPassword = des24(64|44|27|129|192|254|249|136|167|255|215|83|10|203|180|178|19|153|36|18|37|)
